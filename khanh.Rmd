...
I am a Geospatial Analyst in the Landscape Ecology lab! TW wuz here! Fixed a typo in the map caption and did not notice any additional errors.
...
leaflet() %>% 
  addTiles() %>%     
  addMarkers(lng = -71.297210, lat = 44.055972, popup = "Bartlett Experimental Forest")
```
