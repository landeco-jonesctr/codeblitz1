...
2.  Practice the basic workflow: clone, edit, commit, and push.
...
3.  Create a new R markdown (e.g., `jeff.Rmd`) document to make a profile.
...
10. Once merged, your profile will appear here: <https://landeco-jonesctr.github.io/codeblitz1/> (eventually after Khanh edits the yml file and knits the whole website together).
...
-   [Insert one *obviously false* statement about you in the biography]{style="color:red"}.
...
-   [Add a typo in one image path so that the link is broken.]{style="color:red"} Bonus: Make one of the photos a thumbnail with a hyperlink!
